...
public class gpa {
	 ...
	 * @param courseName
	 * @param courseCredit
	 * @param courseGrade  Puts the name and credit into an arraylist,
	...
	public void setCourse(String courseName, String courseCredit, String courseGrade) {
		...
		try {  // If the courseCredit is not a number, save the default, 3
	...
	/**
	 * @param courseGrade Returns the numeric value for a letter grade
	 */
